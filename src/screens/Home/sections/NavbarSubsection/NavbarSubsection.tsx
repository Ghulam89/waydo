...
export const NavbarSubsection = (): JSX.Element => {
  ...
  <img
            ...
            <div className="hidden md:block relative w-64 h-11">
          ...
          <div className="hidden md:inline-flex items-center gap-0.5 relative flex-[0_0_auto]">
            <div className="inline-flex items-center text-gray-500 gap-[18px] relative flex-[0_0_auto]">
              {navigationItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="group-hover:text-red-500">{item.icon}</div>
              ...
              <Link
                to={"/my-ads"}
                className="group  text-gray-500 flex flex-col w-[75px] items-center gap-2 relative cursor-pointer"
              >
                <svg
            ...
            <div className="inline-flex items-center gap-3 pl-3 relative flex-[0_0_auto]">
              {/* <Button
              ...
              >
               ...
               <Link to={"/wallet"}>
                <Button className="h-auto px-[14px]   bg-white text-[#ffffff] text-base font-medium [font-family:'Mona_Sans',Helvetica] border border-solid border-gray-300   shadow-shadow-xs hover:bg-white">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_837_9297)">
<path d="M13.3359 11.6666C13.3359 12.357 13.8956 12.9166 14.5859 12.9166C15.2763 12.9166 15.8359 12.357 15.8359 11.6666C15.8359 10.9763 15.2763 10.4166 14.5859 10.4166C13.8956 10.4166 13.3359 10.9763 13.3359 11.6666Z" stroke="#141B34" stroke-width="1.5"/>
<path d="M15.7526 6.66663C15.8072 6.39737 15.8359 6.11868 15.8359 5.83329C15.8359 3.53211 13.9705 1.66663 11.6693 1.66663C9.36809 1.66663 7.5026 3.53211 7.5026 5.83329C7.5026 6.11868 7.5313 6.39737 7.58595 6.66663" stroke="#141B34" stroke-width="1.5"/>
<path d="M5.83464 6.66101H13.3346C15.6917 6.66101 16.8702 6.66101 17.6024 7.3936C18.3346 8.12618 18.3346 9.30527 18.3346 11.6634V13.3309C18.3346 15.6891 18.3346 16.8681 17.6024 17.6007C16.8702 18.3333 15.6917 18.3333 13.3346 18.3333H8.33464C5.19194 18.3333 3.62059 18.3333 2.64428 17.3565C1.66797 16.3797 1.66797 14.8076 1.66797 11.6634V9.99595C1.66797 6.85174 1.66797 5.27963 2.64428 4.30285C3.43018 3.51657 4.60166 3.36322 6.66797 3.33331H8.33464" stroke="#141B34" stroke-width="1.5" stroke-linecap="round"/>
</g>
<defs>
<clipPath id="clip0_837_9297">
<rect width="20" height="20" fill="white"/>
</clipPath>
</defs>
</svg>
 <span className=" bg-[#ECFDF3] text-[#027A48] text-sm py-1 px-2 rounded-full">1226.5 Waycash</span>
                </Button>
              </Link>
              <Link to={"/post-ads"}>
                <Button className="h-auto px-[14px] py-2.5 bg-primary-600 text-[#ffffff] text-base font-medium [font-family:'Mona_Sans',Helvetica] border border-solid border-[#ff0000] shadow-shadow-xs hover:bg-primary-700">
                  Post Your Ad
                </Button>
              </Link>
               <div className="">
              ...
              {navigationItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      onClick={(e) => openModal(modalNames[index], e)}
                      className="group-hover:[&>svg]:stroke-red-500"
                    >
                      {item.icon}
                    </div>
